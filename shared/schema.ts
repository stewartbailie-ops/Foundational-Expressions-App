...
export const advisorProfiles = pgTable("advisor_profiles", {
  ...
  showToolPension: boolean("show_tool_pension").default(false),
  showToolCgt: boolean("show_tool_cgt").default(false),
